    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div>
            <div class="bg-white border border-gray-200 p-6 rounded-lg shadow-sm">
                ...
                <form action="<?= URL_ROOT ?>/agent/processExit/<?= $ticket->id ?>" method="POST">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="pt-4">
                            <button type="submit" class="w-full bg-green-600 hover:bg-green-700 text-white px-4 py-3 rounded-lg shadow-md transition">
                                <i class="fas fa-check-circle mr-2"></i> Process Payment & Complete Exit
                            </button>
                        </div>
                        
                        <div class="pt-2">
                            <a href="<?= URL_ROOT ?>/agent/ticketDetails/<?= $ticket->id ?>" class="block w-full text-center bg-blue-600 hover:bg-blue-700 text-white px-4 py-3 rounded-lg shadow-md transition">
