                    ...
                    <tbody>
                        <?php foreach ($tickets as $ticket): ?>
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-2 border">
                                    <a href="<?= URL_ROOT ?>/agent/ticketDetails/<?= $ticket->id ?>" class="text-blue-600 hover:underline block">
                                        <i class="fas fa-eye"></i> View
                                    </a>
                                    
                                    <?php if ($ticket->status === 'active'): ?>
                                        <a href="<?= URL_ROOT ?>/agent/processExit/<?= $ticket->id ?>" class="text-green-600 hover:underline block mt-1">
